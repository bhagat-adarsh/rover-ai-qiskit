...
def visualize(rover_pos, goal_pos, grid_size, grid):
    ...
    rx, ry = rover_pos
    gx, gy = goal_pos
    pygame.draw.circle(screen, (0, 0, 255), (ry * cell_size + cell_size // 2, rx * cell_size + cell_size // 2), cell_size // 3)
    pygame.draw.circle(screen, (0, 255, 0), (gy * cell_size + cell_size // 2, gx * cell_size + cell_size // 2), cell_size // 3)
